...
<p align="center">
Figura 5 (Versão Alterada) - Diagrama de Classes<br>Autor: Matheus Perillo e Pedro Siqueira.
</p> <br>
...
<p align="justify">
&emsp;&emsp;A Visão de Dados é uma dimensão crucial na arquitetura de software, mostrando a estrutura fundamental que sustenta as <B>operações de um sistema</B>. No contexto deste documento, exploraremos a Modelo Entidade-Relacionamento (ME-R), um paradigma robusto para <B>representar e organizar dados</B>. O ME-R serve como a espinha dorsal para <B>definir e compreender</B> as interações entre diferentes entidades em um sistema. O Diagrama Entidade-Relacionamento (DE-R) é uma ferramenta para visualizar e compreender a complexidade das relações entre entidades. Já o Diagrama Lógico de Dados (DLD) se trata de uma <b>representação visual</b> da estrutura lógica dos dados, que visa mostrar como os mesmos estarão dispostos nos scripts, por meio de tabelas.
</p>
...
<p align="center">
Figura 8 (Versão Original) - Diagrama Entidade-Relacionamento<br>Autor: Vitor Manoel & Gustavo Barbosa. 2023.
</p> <br>

![](../images/conceitualAmericanasFoto2.png)

<p align="center">
Figura 8 (Versão Alterada) - Diagrama Entidade-Relacionamento<br>Autor: Matheus Perillo e Pedro Siqueira. 2024.
</p> <br>
...
<p align="center">
Figura 9 - Diagrama Lógico de Dados<br>Autor: Matheus Perillo e Pedro Siqueira. 2024.
</p> <br>
